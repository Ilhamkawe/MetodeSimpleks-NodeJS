...
describe('SimpleSimplex', () => {
  it('should generate tableaus properly', () => {
    ...
    expect(firstTableau, 'first tableau not generated properly').to.deep.equal([[2, 1, 10, 20, 3, 1, 0, 0, 0, 100], [-3, -5, -7, -11, -13, 0, 1, 0, 0, -200], [17, 19, 21, 23, 29, 0, 0, 1, 0, 300], [-5, -3, -15, -20, -10, 0, 0, 0, 1, 0]]);

    const secondSolver = new SimpleSimplex(secondProblem);
    const secondTableau = secondSolver.generateTableau();

    expect(secondTableau, 'second tableau not generated properly').to.deep.equal([[1, 1, 1, 1, 0, 0, 0, 600], [1, 3, 0, 0, 1, 0, 0, 600], [2, 0, 1, 0, 0, 1, 0, 900], [-60, -90, -300, 0, 0, 0, 1, 0]]);
  });
  ...
  it('should solve an actual problem', () => {
    ...
    expect(resultProjected, 'simplex method result is incorrect').to.deep.equal({
